import { formatarCEP, formatarCNPJ, formatarCPF, formatarPIS, formatarRENAVAM, formatarTituloEleitor } from "./formatadores";

export type TipoDocumento = "CPF" | "CNPJ" | "CEP" | "PIS" | "RENAVAM" | "TituloEleitor" | "Desconhecido";
...
export function formatarDocumento(documento: string): string {
  ...
  switch (tipo) {
    case "CPF": return formatarCPF(digits) || documento;
    case "CNPJ": return formatarCNPJ(digits) || documento;
    case "CEP": return formatarCEP(digits) || documento;
    case "PIS": return formatarPIS(digits) || documento;
    case "TituloEleitor": return formatarTituloEleitor(digits) || documento;
